...
/**
 * Floor for the "monthly premium" shown on the dashboard when the policy row
 * has no explicit price. Prevents the classic "$0.00 / month" bug when the
 * upstream bot posts `annualPremium: 0` — the customer still owes the
 * standard $100 monthly rate until admin sets a real number.
 */
export const DEFAULT_MONTHLY_PREMIUM_CENTS = 10000
