...
| `APP_URL` | Render | Comma-separated list of allowed domains for redirects (e.g. `https://tristatetag.com,https://tristatetags.com`). Required for both domains to register orders correctly. |
